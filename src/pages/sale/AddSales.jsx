...
const AddSales = (props) => {
  ...
  const useTemplate = {estimate_sub_type:"", estimate_sub_item:"",  estimate_sub_qnty_sqr:"",estimate_sub_qnty:"",estimate_sub_rate:"",estimate_sub_amount:"",sales_sub_item_original:""};
  ...
  useEffect(() => {
      ...
      axios({
          url: BASE_URL+"/api/web-fetch-product-types/"+estimate.estimate_item_type,
          method: "GET",
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
  ...
  const onInputChange = (e) => {
      if(e.target.name=="estimate_mobile"){
          ...
          const total = parseInt(e.target.value || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_gross: total
          }));
          const balance = parseInt(e.target.value || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0) - parseInt(estimate.estimate_advance || 0);
          setEstimate(estimate => ({
              ...estimate,
          ...
          const total = parseInt(estimate.estimate_tax || 0)  + parseInt(e.target.value || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_gross: total
          }));
          const balance = parseInt(estimate.estimate_tax || 0)  + parseInt(e.target.value || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0) - parseInt(estimate.estimate_advance || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_balance: balance
          ...
          const total = parseInt(estimate.estimate_tax || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(e.target.value || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_gross: total
          }));
          const balance = parseInt(estimate.estimate_tax || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(e.target.value || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0) - parseInt(estimate.estimate_advance || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_balance: balance
          ...
          const total = parseInt(estimate.estimate_tax || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(e.target.value || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_gross: total
          }));
          const balance = parseInt(estimate.estimate_tax || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(e.target.value || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0) - parseInt(estimate.estimate_advance || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_balance: balance
          }));
          ...
          const total = parseInt(estimate.estimate_tax || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(e.target.value || 0) + parseInt(valu || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_gross: total
          }));
          const balance = parseInt(estimate.estimate_tax || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(e.target.value || 0) + parseInt(valu || 0) - parseInt(estimate.estimate_advance || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_balance: balance
          }));
          ...
          const balance = parseInt(estimate.estimate_tax || 0)  + parseInt(estimate.estimate_tempo || 0) + parseInt(estimate.estimate_loading || 0)
          + parseInt(estimate.estimate_unloading || 0) + parseInt(estimate.estimate_other || 0) + parseInt(valu || 0) - parseInt(e.target.value || 0);
          setEstimate(estimate => ({
              ...estimate,
              estimate_balance: balance
          }));
  ...
  const QntyCal = (selectedValue) => {
      ...
      tempUsers[selectedValue].estimate_sub_amount = tempUsers[selectedValue].estimate_sub_qnty_sqr * tempUsers[selectedValue].estimate_sub_rate;
      setUsers(tempUsers);
                            ...
                            <div className="form-group">
                                ...
                                >
                                   {product.map((fabric, key) => (
                                                        <MenuItem key={fabric.product_type} value={fabric.product_type}>
                                                            {fabric.product_type}
                                                        </MenuItem>
                                                        ))}
